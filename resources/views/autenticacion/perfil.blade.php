            ...
            <div class="card-body">
                ...
                <form action="{{ route('perfil.update', $user) }}" method="POST">
                    ...
                    <div class="form-control">
                        ...
                        <input type="text" name="name" placeholder="Nombre" class="input inputbordered"
                    ...
                    <div class="form-control">
                        ...
                        <input type="email" name="email" placeholder="Email" class="input inputbordered" maxlength="255"
                            value="{{ $user->email }}" />
                    </div>
                    <div class="form-control">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('password.update', $user) }}" method="POST">
                    ...
                    <div class="form-control">
                        ...
                        <input type="password" name="password_old" placeholder="Ingrese la contraseña actual"
                            class="input input-bordered" maxlength="45" required />
                    </div>
                    <div class="form-control">
                    ...
                    <div class="form-control">
                        ...
                        <input type="password" name="password_confirmation" placeholder="Confirme la nueva contraseña"
                            class="input input-bordered" maxlength="45" required />
                    </div>
                    <div class="form-control mt-6 w-1/2">
