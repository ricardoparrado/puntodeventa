            ...
            <div class="card-body">
                ...
                <form action="{{ route('registro.store') }}" method="POST">
                    ...
                    <div class="form-control">
                        ...
                        <input type="password" name="password" placeholder="Mínimo 5 caracteres" maxlength="45"
                    ...
                    <div class="form-control">
                        ...
                        <input type="password" name="password_confirmation" placeholder="Confirmar password" maxlength="45"
                            class="input input-sm input-bordered" required />
                    </div>
                    {{-- Direccion --}}
                    <div class="form-control">
                        ...
                        <input type="text" name="address" placeholder="Escriba la dirección para envíos" maxlength="255"
                            class="input input-sm input-bordered" required value="{{ old('address') }}" />
                    </div>
                    {{-- Botones --}}
                    <div class="form-control mt-6">
                        <button class="btn btn-sm btn-primary">Crear cuenta</button>
                        <a href="{{ route('productos.index') }}" class="btn btn-sm btn-outline btn-primary mt-4">Cancelar</a>
                    </div>
                </form>
            </div>
        </div>
