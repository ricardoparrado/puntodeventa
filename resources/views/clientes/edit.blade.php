                ...
                <div class="card-body space-y-4">
                    ...
                    <form action="{{ route('clientes.update', $cliente->id) }}" method="POST" class="space-y-4">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nombre" class="w-full p-2 border border-gray-300 rounded"
                                id="nombre" value="{{ $cliente->nombre }}" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="flex justify-center">
                            ...
                            <button class="bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded ml-2">Actualizar Cliente</button>
                        </div>
                    </form>
                </div>
            </div>
