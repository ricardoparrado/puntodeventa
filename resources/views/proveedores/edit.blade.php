                    ...
                    <form method="POST" action="{{ route('proveedores.update', $proveedor->id) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="nombre" id="nombre"
                                class="w-full p-2 border border-gray-300 rounded" value="{{ $proveedor->nombre }}">
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="telefono" id="telefono"
                                class="w-full p-2 border border-gray-300 rounded" value="{{ $proveedor->telefono }}">
                        </div>
                        ...
                        <div class="flex justify-center">
                            ...
                            <a href="{{ route('proveedores.index') }}"
                                class="bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded ml-2">Regresar</a>
                        </div>
