        ...
        <div class="w-full max-w-md mx-auto">
            <div class="card bg-white rounded-lg shadow-lg">
                <div class="card-body">
                    ...
                    <form action="{{ route('ventas.store') }}" method="POST" class="w-full max-w-lg space-y-4">
                        @csrf
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" step="0.01" name="total"
                                class="w-full p-2 border border-gray-300 rounded" id="total" required>
                        </div>
